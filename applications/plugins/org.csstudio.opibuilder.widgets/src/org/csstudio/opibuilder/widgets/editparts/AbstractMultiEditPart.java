...
import org.csstudio.swt.widgets.figures.AbstractMultiFigure.BoolLabelPosition;
...
public abstract class AbstractMultiEditPart extends AbstractPVWidgetEditPart {
	...
	protected void registerCommonPropertyChangeHandlers() {
		...
		setPropertyChangeHandler(AbstractMultiWidgetModel.PROP_BIT, handler);
		...
		getWidgetModel().getProperty(AbstractMultiWidgetModel.PROP_DATA_TYPE).
		...
		setPropertyChangeHandler(AbstractMultiWidgetModel.PROP_SHOW_BOOL_LABEL, handler);
		...
		setPropertyChangeHandler(AbstractMultiWidgetModel.PROP_BOOL_LABEL_POS, handler);
	...
	public Boolean getValue() {
		return ((AbstractMultiFigure)getFigure()).getBooleanValue();
	}
	/**
	 * @param newValue
	 * @param figure
